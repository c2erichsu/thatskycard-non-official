            ...
            {value =>
                <form>
                    ...
                    <div class="input-group mb-3">
                        ...
                        <input type="file" class="form-control" onChange={e => value.setImg_url(convertURL(e))} />
                    </div>

                    <div class="input-group mb-3">
                        <label class="input-group-text"> Name </label>
                        <input type="text" id="name" class="form-control" onChange={e => value.setName(e.target.value)} />
                    </div>
